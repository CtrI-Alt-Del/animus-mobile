...
7. **Atualização de spec**
   - Caso, após a implementação do plano, seja pedido alterações na implementação, verifique se as alterações diferem da spec e atualize o plano.
