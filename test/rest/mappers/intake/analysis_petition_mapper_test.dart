...
void main() {
  group('AnalysisPetitionMapper', () {
    test('should map case summary from summary and preserve typed petition', () {
      ...
      expect(dto.petition.document.filePath, 'uploads/petitions/petition-1.pdf');
    ...
    test('should keep legacy compatibility with petition_summary', () {
      final dto = AnalysisPetitionMapper.toDto(<String, dynamic>{
        ...
        'petition_summary': <String, dynamic>{
          'case_summary': 'Resumo legado',
        },
      });
