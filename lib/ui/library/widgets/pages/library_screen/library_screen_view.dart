...
import 'package:animus/ui/library/widgets/pages/library_folder_screen/move_analyses_modal/index.dart';
import 'package:animus/ui/library/widgets/pages/library_screen/create_folder_modal/index.dart';
import 'package:animus/ui/library/widgets/pages/library_screen/empty_state/index.dart';
import 'package:animus/ui/library/widgets/pages/library_screen/folder_grid_card/index.dart';
import 'package:animus/ui/library/widgets/pages/library_screen/library_screen_presenter.dart';
import 'package:animus/ui/library/widgets/pages/library_screen/library_tabs/index.dart';
import 'package:animus/ui/library/widgets/pages/library_screen/new_folder_button/index.dart';
import 'package:animus/ui/library/widgets/pages/library_screen/section_header/index.dart';
                ...
                return ListView(
                  ...
                  children: <Widget>[
                    ...
                    if (operationError != null) ...<Widget>[
                      const SizedBox(height: 16),
                      _InlineOperationError(message: operationError),
                    ],
                    const SizedBox(height: 24),
                    if (selectedTab == 0 &&
...
class _InlineOperationError extends StatelessWidget {
  ...
  const _InlineOperationError({required this.message});
